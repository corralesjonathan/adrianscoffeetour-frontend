 ...
 */
export function NewsletterSuccessModal({ show, onClose }) {
  if (!show) return null;
  ...
  return (
    <div className="fixed inset-0 bg-black/20 flex items-center justify-center z-[9999]">
      ...
      >
        ...
        <h2 className="text-2xl font-bold text-adrians-brown mb-4">Subscription Successful!</h2>
        <p className="text-adrians-brown mb-4">Thank you for joining our coffee family. You'll receive exclusive updates and offers in your inbox.</p>
      </motion.div>
    </div>
  );
}
