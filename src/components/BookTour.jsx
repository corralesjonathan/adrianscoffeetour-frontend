...
export function BookTour() {
    return (
        <div className="grid grid-cols-5 gap-[20px] absolute top-[100%] left-[50%] translate-x-[-50%] translate-y-[-50%] w-[80vw] h-fit p-[40px] rounded-[20px] items-center justify-center bg-white shadow-adrians-horizontal-card
            ...
            <div className="flex flex-col gap-[20px] w-full justify-center items-center">
                <div className="flex gap-[10px] w-full items-center justify-start">
                    ...
                    <button className="cursor-pointer">
                        <img className="hover:scale-110 transition-all duration-300 ease-in-out" src="./icons/info.svg" alt="Info" />
                    </button>
                </div>
