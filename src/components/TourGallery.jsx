    ...
    return (
        <div 
            ...
            <div 
                ...
                <div className="overflow-hidden w-full h-[600px] rounded-[20px]">
                    <img 
                ...
                <div 
                    className="flex flex-col gap-[20px] h-[600px]
                    max-lg:flex-row max-lg:col-span-2 max-sm:col-span-1
                    ">
                    <div 
                        className="overflow-hidden w-full h-[60%] rounded-[20px]
                        max-lg:h-[40%]
                        ">
                        <img 
                    ...
                    <div className="overflow-hidden w-full h-[40%] rounded-[20px]">
                        <img 
